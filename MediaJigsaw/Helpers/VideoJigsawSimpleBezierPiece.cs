...
{
    internal class VideoJigsawSimpleBezierPiece : VideoJigsawPieceBase
    {
        public VideoJigsawSimpleBezierPiece(MediaElement mediaElement, int col, int row, double pieceSize)
